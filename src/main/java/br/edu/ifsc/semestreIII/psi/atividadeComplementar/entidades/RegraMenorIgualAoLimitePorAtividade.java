...
public class RegraMenorIgualAoLimitePorAtividade implements Regra{
	private double somaHoras;
	private Requerimento requerimento;
    
    public RegraMenorIgualAoLimitePorAtividade(double somaHoras, Requerimento requerimento) {
